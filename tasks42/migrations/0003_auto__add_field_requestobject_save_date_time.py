...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'tasks42_requestobject', 'save_date_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 10, 28, 0, 0)),
                      keep_default=False)
    ...
    models = {
        ...
        u'tasks42.requestobject': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'save_date_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 28, 0, 0)'})
        }
    }
